...
void Monster::show() {
	...
	cout << "Pojawia si� " << name << "\nwarto�� jego punkt�w �ycia to :" << hp<<endl;
	cout << "staty drania: " << agility << " zr�czno�ci, " << attack << " ataku, " << def << " defa!" << endl;
}
...
void Monster::spown_monster(int h, int a, int d, int agi, int e, string n) {
	...
	system("pause");
	system("cls");
	cout << "Atakuje Ci�: " << name << endl;
	cout << "Posiada on: " << hp << " punkt�w �ycia" << endl;
	cout << "Oraz: " << attack << " ataku i " << def << " obrony" << endl;
	system("pause");
}
// metody pobieraj�ce r�ne statystyki klasy monster 
